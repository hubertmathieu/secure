...
abstract class SecurityController extends ZephyrusBaseController
{
    ...
    private function setupAuthorizations()
    {
         ...
         */
        parent::getAuthorization()->protect('/ajax', Authorization::ALL, 'public');
        parent::getAuthorization()->protect('/login', Authorization::ALL, 'public');
        parent::getAuthorization()->protect('/inscription', Authorization::ALL, 'public');
        parent::getAuthorization()->protect('/index', Authorization::ALL, 'public');
        parent::getAuthorization()->protect('/manager', Authorization::ALL, 'connected');
        parent::getAuthorization()->protect('/home', Authorization::ALL, 'connected');
        parent::getAuthorization()->protect('/manager/{0-9}', Authorization::ALL, 'connected');
        parent::getAuthorization()->protect('/credit-card', Authorization::ALL, 'connected');
        parent::getAuthorization()->protect('/add-password', Authorization::ALL, 'connected');
        parent::getAuthorization()->protect('/add-credit', Authorization::ALL, 'connected');
        parent::getAuthorization()->protect('/favorite', Authorization::ALL, 'connected');
        parent::getAuthorization()->protect('/delete', Authorization::ALL, 'connected');
        parent::getAuthorization()->protect('/delete/{0-9}', Authorization::ALL, 'connected');
        parent::getAuthorization()->protect('/delete/{0-9}/confirmation', Authorization::ALL, 'connected');
        parent::getAuthorization()->protect('/shared', Authorization::ALL, 'connected');
        parent::getAuthorization()->protect('/deleteCredit/{0-9}', Authorization::ALL, 'connected');
        parent::getAuthorization()->protect('/deleteCredit/{0-9}/confirmation', Authorization::ALL, 'connected');
